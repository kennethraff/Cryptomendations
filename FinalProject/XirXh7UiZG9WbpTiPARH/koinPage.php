...
<body>
    ...
    <section id="portfolio" class="portfolio bg-light pb-4">
        <div class="container">
            ...
            <a href="createKoinPage.php" class="btn btn-primary mt-5 text-center">Create new coin</a>
                ...
                ?>
                        <div class="col-sm-4 card justify-content-center m-2" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="updateKoin.php?update_id=<?= $barisdata["id"] ?>" class="btn btn-primary">Update</a>
                            </div>
                        </div>
