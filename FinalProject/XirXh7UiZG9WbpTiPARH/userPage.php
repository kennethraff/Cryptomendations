    ...
    <table class="table mt-2">
        ...
        <tbody class="table-group-divider ">
            <tr>
                ...
                ?>
                    <th><a href="userDetailPage.php?update_id=<?= $barisdata["id"] ?>">Detail</a> <?= $barisdata["id"] ?><br><a href="update.php?update_id=<?= $barisdata["id"] ?>"class="btn btn-warning">Update</a><form action="delete.php" method="POST" enctype="multipart/form-data">
