...
<body>
    ...
    ?>
        <div class="container turun">
            <h1>Detail coin data with ID <?= $data_to_be_detail ?></h1>
            <form action="deleteKoin.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="delete_coin_id" value="<?= $data["id"] ?>">
